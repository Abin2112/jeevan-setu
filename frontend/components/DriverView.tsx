...
export const DriverView: React.FC<DriverViewProps> = ({ status, onAccept, pendingRequest }) => {
    return (
                            ...
                            <div className="flex gap-4 mb-6">
                                ...
                                <div className="w-2/3 space-y-3">
                                    <div>
                                        ...
                                        <div className="text-white font-bold text-lg capitalize">{pendingRequest?.type || 'Road Accident'}</div>
                                    </div>
                                    <div>
                                        <div className="text-gray-500 text-xs uppercase">Distance</div>
                                        <div className="text-white font-bold text-lg">{pendingRequest?.distance || '2.4 km'}</div>
                                    </div>
                                </div>
                            </div>
